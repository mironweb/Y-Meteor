...
@Component({
  selector: 'salesManager-dashboard',
  templateUrl: 'salesManager-dashboard.page.html',
  styleUrls: ['salesManager.scss'],
}) 

export class SalesManagerDashboardPage implements OnInit{
